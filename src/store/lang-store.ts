...
const translations = {
  ...
  'admin.deliveredOrders': { mn: 'Хүргэсэн захиалга', en: 'Delivered Orders' },
  'admin.products': { mn: 'Бүтээгдэхүүн', en: 'Products' },
  'admin.availableProducts': { mn: 'Байгаа бүтээгдэхүүн', en: 'Available Products' },
  ...
  'admin.productCreated': { mn: 'Бүтээгдэхүүн амжилттай нэмэгдлээ', en: 'Product added successfully' },
  ...
  'admin.categoryCreated': { mn: 'Ангилал амжилттай нэмэгдлээ', en: 'Category added successfully' },
  ...
  'profile.requiredNote': { mn: 'Хувь хүнд нэр, утас, хаяг заавал. Байгууллагад компанийн үндсэн мэдээлэл мөн заавал бөглөгдөнө.', en: 'For individuals, name, phone, and address are required. Company accounts also require core company details.' },
  'profile.requiredTitle': { mn: 'Шаардлагатай мэдээллээ бөглөнө үү', en: 'Fill in the required fields' },
  'profile.requiredDesc': { mn: 'Нэр, утас, хаяг талбаруудыг хадгалахын өмнө бөглөнө үү.', en: 'Please complete name, phone, and address before saving.' },
  'profile.companyRequiredTitle': { mn: 'Байгууллагын мэдээлэл дутуу байна', en: 'Company details are incomplete' },
  'profile.companyRequiredDesc': { mn: 'Байгууллагын нэр, регистр, чиглэл, ажилтны тоо, албан тушаал, и-мэйл талбаруудыг бөглөнө үү.', en: 'Please complete company name, registration number, sector, employee count, job title, and company email.' },
  'profile.fillRequired': { mn: 'Энэ талбарыг бөглөнө үү.', en: 'Please fill out this field.' },
  'profile.customerType': { mn: 'Харилцагчийн төрөл', en: 'Customer Type' },
  'profile.individual': { mn: 'Хувь хүн', en: 'Individual' },
  'profile.companyCustomer': { mn: 'Байгууллага', en: 'Company' },
  'profile.selectOption': { mn: 'Сонгоно уу', en: 'Select an option' },
  ...
  'profile.companyRegistrationNumber': { mn: 'Байгууллагын регистрийн дугаар', en: 'Company Registration Number' },
  'profile.businessSector': { mn: 'Үйл ажиллагааны чиглэл', en: 'Business Sector' },
  'profile.employeeCount': { mn: 'Ажилтны тоо', en: 'Employee Count' },
  'profile.jobTitle': { mn: 'Таны албан тушаал', en: 'Your Job Title' },
  'profile.companyEmail': { mn: 'Байгууллагын и-мэйл хаяг', en: 'Company Email' },
  'profile.companyPhone': { mn: 'Байгууллагын утасны дугаар', en: 'Company Phone' },
  'profile.sector.construction': { mn: 'Барилга', en: 'Construction' },
  'profile.sector.mining': { mn: 'Уул уурхай', en: 'Mining' },
  'profile.sector.manufacturing': { mn: 'Үйлдвэрлэл', en: 'Manufacturing' },
  'profile.sector.logistics': { mn: 'Ложистик', en: 'Logistics' },
  'profile.sector.energy': { mn: 'Эрчим хүч', en: 'Energy' },
  'profile.sector.retail': { mn: 'Худалдаа', en: 'Retail' },
  'profile.sector.other': { mn: 'Бусад', en: 'Other' },
