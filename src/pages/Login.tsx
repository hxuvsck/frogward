    ...
    <Layout>
      <div className="container max-w-md py-20">
        <div className="text-center mb-8">
          <h1 className="font-heading text-3xl font-bold">Sign in to <span className="text-primary">FROG</span>WARD</h1>
          <p className="text-muted-foreground mt-2 text-sm">Access your account, orders, and more.</p>
        </div>
